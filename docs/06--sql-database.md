...
`pl.tnykiel.ecommerce.playground.SqlTest` 
...
* [src/test/java/pl/jkanclerz/ecommerce/playground/SqlTest.java](../src/test/java/pl/tnykiel/ecommerce/playground/SqlTest.java)
